/**credit Lejian Luo
 * search function restores page state when search bar is empty
 * 
 * genre filters take priority than searh function
 * search function only searchs under active gene content
 * 
 */

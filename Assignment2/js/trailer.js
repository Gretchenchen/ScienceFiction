/** Credit Lejian Luo
 * stores all the film name and matching trailer link
 * when watch trailer buttons are clicked, hide all contents under the main tag in html page.
 * display trailer and close button on top
 * when close button is clicked, hide video and close button, restore original content
 * 
 * 
 * 
*/

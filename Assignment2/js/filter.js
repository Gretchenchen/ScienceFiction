/**credit Lejian Luo
 * state array stores all the genre filter buttons and their on off state
 * filterdropbr function displays the genre filter buttons
 * clickAll function displays all content and set all other buttns to off
 * clickState function set the on/off state of other genre filters and display selected content
 */
